...
%    end
    ...
    if i==1;
%    cd f:\lakes\narr\32years;    
    %save(['narr_quebec_pressure_',num2str(year)],'pressfc','slon','slat','limits','time');
    %save(['narr_alberta_pressure_',num2str(year)],'pressfc','slon','slat','limits','time');
    save(['narr_TAN_pressure_',num2str(year)],'pressfc','slon','slat','limits','time');
    end
%    if i==2;
