...
%    end
    ...
    if i==1;
%    cd f:\lakes\narr\32years;    
    %save(['narr_quebec_shortwaveradiation_',num2str(year)],'dswrf','slon','slat','limits','time');
    %save(['narr_alberta_shortwaveradiation_',num2str(year)],'dswrf','slon','slat','limits','time');
    save(['narr_TAN_shortwaveradiation_',num2str(year)],'dswrf','slon','slat','limits','time');
    end
%    if i==2;
