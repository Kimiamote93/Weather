...
%    end
    ...
    if i==1;
%    cd f:\lakes\narr\32years;    
    %save(['narr_quebec_cloudcover_',num2str(year)],'tcdc','slon','slat','limits','time');
    %save(['narr_alberta_cloudcover_',num2str(year)],'tcdc','slon','slat','limits','time');
    save(['narr_TAN_cloudcover_',num2str(year)],'tcdc','slon','slat','limits','time');
    end
%    if i==2;
