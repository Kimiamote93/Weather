...
% limits = [83.091 83.093 -74.133 -74.130];      %[min_lat max_lat min_lon max_lon]
years = (2016:1:2022); 
% years = 2022 ;
...
%         cldcov = permute(var,[2 3 1]);
         airtmp = permute(var,[2 3 1]);
       end
%       if i==2;       
...
%    end
    ...
    if i==1;
%    cd f:\lakes\narr\32years;    
%    save(['narr_quebec_airtemperature_',num2str(year)],'airtmp','slon','slat','limits','time');
%    save(['narr_alberta_airtemperature_',num2str(year)],'airtmp','slon','slat','limits','time');
    save(['narr_TAN_airtemperature_',num2str(year)],'airtmp','slon','slat','limits','time');
    end
%    if i==2;
