...
%    end
    ...
    if i==1;
 %   cd f:\lakes\narr\32years;    
    %save(['narr_quebec_relativehumidity_',num2str(year)],'rhum','slon','slat','limits','time');
    %save(['narr_alberta_relativehumidity_',num2str(year)],'rhum','slon','slat','limits','time');
    save(['narr_TAN_relativehumidity_',num2str(year)],'rhum','slon','slat','limits','time');
    end
%    if i==2;
