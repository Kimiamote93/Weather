...
% this version, March 2012 (one parameter, 32 years, writes 32 files)

clear all

addpath 'C:\MyLake\First Chapter\Weather\ReAnalysis\Input\mexcdf.r4053\mexcdf\mexnc'
addpath 'C:\MyLake\First Chapter\Weather\ReAnalysis\Input\mexcdf.r4053\mexcdf\snctools'
...
% path(path,'C:\MyLake\Bylot\from_NARR_to_meteo_forcing_data_for_MyLake\mexcdf.r4053\mexcdf\snctools\private');
...
%    end
    ...
    if i==1;
%    cd f:\lakes\narr\32years;    
%    save(['narr_quebec_precipitation_',num2str(year)],'apcp','slon','slat','limits','time');
%    save(['narr_alberta_precipitation_',num2str(year)],'apcp','slon','slat','limits','time');
    save(['narr_TAN_precipitation_',num2str(year)],'apcp','slon','slat','limits','time');
    end
%    if i==2;
