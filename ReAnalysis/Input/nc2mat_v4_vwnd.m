...
%    end
    ...
    if i==1;
%    cd f:\lakes\narr\32years;    
    %save(['narr_quebec_wind_v_',num2str(year)],'vwnd','slon','slat','limits','time');
    %save(['narr_alberta_wind_v_',num2str(year)],'vwnd','slon','slat','limits','time');
    save(['narr_TAN_wind_v_',num2str(year)],'vwnd','slon','slat','limits','time');
    end
%    if i==2;
